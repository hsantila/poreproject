...
/*----------------------------------------------------------------------*/
// THIS VERSION IS MEAN FOR PORE SIMULATIONS; TWO TYPES OF IMMOBILE PARTICLES, NP is the number of charged particles. Pore can be neutral, single polymer. For now, implementation by setting the other polymer to zero and Npol=1; BAD for vectorization
